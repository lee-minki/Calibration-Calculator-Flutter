      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: _buildRangeCard('INPUT LOW', inputLow, 'inputLow'),
              ),
              const SizedBox(width: 8),
              Expanded(
                child: _buildRangeCard('INPUT HIGH', inputHigh, 'inputHigh'),
              ),
            ],
          ),
          ...
          Row(
            children: [
              Expanded(
                child: _buildRangeCard('OUTPUT LOW', outputLow, 'outputLow'),
              ),
              const SizedBox(width: 8),
              Expanded(
                child: _buildRangeCard('OUTPUT HIGH', outputHigh, 'outputHigh'),
              ),
            ],
          ),
