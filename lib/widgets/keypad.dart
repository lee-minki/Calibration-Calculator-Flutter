  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        // Number keys
        Row(children: [_buildKey('7'), _buildKey('8'), _buildKey('9'), _buildFuncKey('CA')]),
        const SizedBox(height: 6),
        Row(children: [_buildKey('4'), _buildKey('5'), _buildKey('6'), _buildFuncKey('C')]),
        const SizedBox(height: 6),
        Row(children: [_buildKey('1'), _buildKey('2'), _buildKey('3'), _buildFuncKey('⌫')]),
        const SizedBox(height: 6),
        Row(children: [_buildKey('0'), _buildKey('.'), _buildFuncKey('±'), _buildCalcKey('Calc')]),
      ],
    );
  }
